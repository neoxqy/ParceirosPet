...
if (
    ...
    $sql = "INSERT INTO usuario (nome_usuario, cpf_usuario, email_usuario, senha_usuario, telefone_usuario, data_criacao, contar_usuario) 
    VALUES (?, ?, ?, ?, ?, NOW(), ?)";

    $stmt = $conn->prepare($sql);

    if ($stmt->execute([$nome, $cpf, $email, $senhaHash, $telefone, 1])) {
