...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $sql = "INSERT INTO voluntario (
                    nome_voluntario, telefone_voluntario, rua_voluntario, cidade_voluntario, cep_voluntario, uf_voluntario, ong_voluntario, contar_voluntario
                ) 
                VALUES (
                    :nome, :telefone, :rua, :cidade, :cep, :uf, :ong, :contar
                )";
